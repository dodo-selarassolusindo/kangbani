...
class PajakView extends Pajak
{
    ...
    // CSS class/style
    public $CurrentPageName = "pajakview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "pajaklist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "pajaklist"; // No matching record, return to list
                    } else {
