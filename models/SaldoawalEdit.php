 ...
 * Page class
 */
class SaldoawalEdit extends Saldoawal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SaldoawalEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "saldoawaledit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("saldoawallist"); // Return to list page
                        return;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // periode_id
        $this->periode_id->setDbValueDef($rsnew, $this->periode_id->CurrentValue, $this->periode_id->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['periode_id'])) { // periode_id
            $this->periode_id->CurrentValue = $row['periode_id'];
        }
