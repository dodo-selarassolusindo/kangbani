 ...
 * Page class
 */
class SubgrupAdd extends Subgrup
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "subgrupadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "subgrupview") {
    ...
    protected function getAddRow()
    {
        ...
        // grup_id
        $this->grup_id->setDbValueDef($rsnew, $this->grup_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['grup_id'])) { // grup_id
            $this->grup_id->setFormValue($row['grup_id']);
        }
