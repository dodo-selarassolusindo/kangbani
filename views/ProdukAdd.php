...
$Page->showMessage();
?>
<form name="fprodukadd" id="fprodukadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<span id="el_produk_kelompok_id">
    <select
        ...
        data-select2-id="fprodukadd_x_kelompok_id"
        <?php } ?>
        data-table="produk"
...
<?php if (!$Page->kelompok_id->IsNativeSelect) { ?>
<script>
loadjs.ready("fprodukadd", function() {
    var options = { name: "x_kelompok_id", selectId: "fprodukadd_x_kelompok_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprodukadd.lists.kelompok_id?.lookupOptions.length) {
        options.data = { id: "x_kelompok_id", form: "fprodukadd" };
    } else {
        options.ajax = { id: "x_kelompok_id", form: "fprodukadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_produk_satuan_id">
    <select
        ...
        data-select2-id="fprodukadd_x_satuan_id"
        <?php } ?>
        data-table="produk"
...
<script>
loadjs.ready("fprodukadd", function() {
    var options = { name: "x_satuan_id", selectId: "fprodukadd_x_satuan_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprodukadd.lists.satuan_id?.lookupOptions.length) {
        options.data = { id: "x_satuan_id", form: "fprodukadd" };
    } else {
        options.ajax = { id: "x_satuan_id", form: "fprodukadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_produk_satuan_id2">
    <select
        ...
        data-select2-id="fprodukadd_x_satuan_id2"
        <?php } ?>
        data-table="produk"
...
<script>
loadjs.ready("fprodukadd", function() {
    var options = { name: "x_satuan_id2", selectId: "fprodukadd_x_satuan_id2" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprodukadd.lists.satuan_id2?.lookupOptions.length) {
        options.data = { id: "x_satuan_id2", form: "fprodukadd" };
    } else {
        options.ajax = { id: "x_satuan_id2", form: "fprodukadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_produk_gudang_id">
    <select
        ...
        data-select2-id="fprodukadd_x_gudang_id"
        <?php } ?>
        data-table="produk"
...
<script>
loadjs.ready("fprodukadd", function() {
    var options = { name: "x_gudang_id", selectId: "fprodukadd_x_gudang_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprodukadd.lists.gudang_id?.lookupOptions.length) {
        options.data = { id: "x_gudang_id", form: "fprodukadd" };
    } else {
        options.ajax = { id: "x_gudang_id", form: "fprodukadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_produk_akunhpp">
    <select
        ...
        data-select2-id="fprodukadd_x_akunhpp"
        <?php } ?>
        data-table="produk"
...
<script>
loadjs.ready("fprodukadd", function() {
    var options = { name: "x_akunhpp", selectId: "fprodukadd_x_akunhpp" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprodukadd.lists.akunhpp?.lookupOptions.length) {
        options.data = { id: "x_akunhpp", form: "fprodukadd" };
    } else {
        options.ajax = { id: "x_akunhpp", form: "fprodukadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_produk_akunjual">
    <select
        ...
        data-select2-id="fprodukadd_x_akunjual"
        <?php } ?>
        data-table="produk"
...
<script>
loadjs.ready("fprodukadd", function() {
    var options = { name: "x_akunjual", selectId: "fprodukadd_x_akunjual" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprodukadd.lists.akunjual?.lookupOptions.length) {
        options.data = { id: "x_akunjual", form: "fprodukadd" };
    } else {
        options.ajax = { id: "x_akunjual", form: "fprodukadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_produk_akunpersediaan">
    <select
        ...
        data-select2-id="fprodukadd_x_akunpersediaan"
        <?php } ?>
        data-table="produk"
...
<script>
loadjs.ready("fprodukadd", function() {
    var options = { name: "x_akunpersediaan", selectId: "fprodukadd_x_akunpersediaan" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprodukadd.lists.akunpersediaan?.lookupOptions.length) {
        options.data = { id: "x_akunpersediaan", form: "fprodukadd" };
    } else {
        options.ajax = { id: "x_akunpersediaan", form: "fprodukadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_produk_akunreturjual">
    <select
        ...
        data-select2-id="fprodukadd_x_akunreturjual"
        <?php } ?>
        data-table="produk"
...
<script>
loadjs.ready("fprodukadd", function() {
    var options = { name: "x_akunreturjual", selectId: "fprodukadd_x_akunreturjual" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprodukadd.lists.akunreturjual?.lookupOptions.length) {
        options.data = { id: "x_akunreturjual", form: "fprodukadd" };
    } else {
        options.ajax = { id: "x_akunreturjual", form: "fprodukadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_produk_supplier_id">
    <select
        ...
        data-select2-id="fprodukadd_x_supplier_id"
        <?php } ?>
        data-table="produk"
...
<script>
loadjs.ready("fprodukadd", function() {
    var options = { name: "x_supplier_id", selectId: "fprodukadd_x_supplier_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprodukadd.lists.supplier_id?.lookupOptions.length) {
        options.data = { id: "x_supplier_id", form: "fprodukadd" };
    } else {
        options.ajax = { id: "x_supplier_id", form: "fprodukadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_produk_waktukirim">
    <select
        ...
        data-select2-id="fprodukadd_x_waktukirim"
        <?php } ?>
        data-table="produk"
...
<script>
loadjs.ready("fprodukadd", function() {
    var options = { name: "x_waktukirim", selectId: "fprodukadd_x_waktukirim" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprodukadd.lists.waktukirim?.lookupOptions.length) {
        options.data = { id: "x_waktukirim", form: "fprodukadd" };
    } else {
        options.ajax = { id: "x_waktukirim", form: "fprodukadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fprodukadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
