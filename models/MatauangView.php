 ...
 * Page class
 */
class MatauangView extends Matauang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MatauangView";
    ...
    // CSS class/style
    public $CurrentPageName = "matauangview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "matauanglist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "matauanglist"; // No matching record, return to list
                    } else {
