 ...
 * Page class
 */
class SubgrupEdit extends Subgrup
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubgrupEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "subgrupedit";
    ...
    public function run()
    {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("subgruplist"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("subgruplist"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "subgruplist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "subgruplist") {
                            ...
                            $returnUrl = "subgruplist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function getEditRow($rsold)
    {
        ...
        // grup_id
        $this->grup_id->setDbValueDef($rsnew, $this->grup_id->CurrentValue, $this->grup_id->ReadOnly);
    ...
    {
        if (isset($row['grup_id'])) { // grup_id
            $this->grup_id->CurrentValue = $row['grup_id'];
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("subgruplist"), "", $this->TableVar, true);
        $pageId = "edit";
