 ...
 * Page class
 */
class SubgrupView extends Subgrup
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubgrupView";
    ...
    // CSS class/style
    public $CurrentPageName = "subgrupview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "subgruplist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "subgruplist"; // No matching record, return to list
                    } else {
