 ...
 * Page class
 */
class JurnaldView extends Jurnald
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JurnaldView";
    ...
    // CSS class/style
    public $CurrentPageName = "jurnaldview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "jurnaldlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "jurnaldlist"; // No matching record, return to list
                    } else {
