 ...
 * Page class
 */
class JurnaldDelete extends Jurnald
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JurnaldDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jurnalddelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jurnaldlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("jurnaldlist"); // Return to list
                return;
            }
        }
