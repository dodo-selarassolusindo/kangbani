 ...
 * Page class
 */
class SaldoawalDelete extends Saldoawal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SaldoawalDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "saldoawaldelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("saldoawallist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("saldoawallist"); // Return to list
                return;
            }
        }
