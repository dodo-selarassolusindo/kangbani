...
class KursDelete extends Kurs
{
    ...
    // CSS class/style
    public $CurrentPageName = "kursdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("kurslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("kurslist"); // Return to list
                return;
            }
        }
