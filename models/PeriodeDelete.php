 ...
 * Page class
 */
class PeriodeDelete extends Periode
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeriodeDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "periodedelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("periodelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("periodelist"); // Return to list
                return;
            }
        }
