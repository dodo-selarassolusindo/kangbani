 ...
 * Page class
 */
class SubgrupDelete extends Subgrup
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubgrupDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("subgruplist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("subgruplist"); // Return to list
                return;
            }
        }
