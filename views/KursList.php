...
<?php } ?>
<div id="gmp_kurs" class="card-body ew-grid-middle-panel <?= $Page->TableContainerClass ?>" style="<?= $Page->TableContainerStyle ?>">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit() || $Page->isMultiEdit()) { ?>
<table id="tbl_kurslist" class="<?= $Page->TableClass ?>"><!-- .ew-table -->
<thead>
...
<?php if ($Page->tanggal->Visible) { // tanggal ?>
        <th data-name="tanggal" class="<?= $Page->tanggal->headerCellClass() ?>"><div id="elh_kurs_tanggal" class="kurs_tanggal"><?= $Page->renderFieldHeader($Page->tanggal) ?></div></th>
<?php } ?>
<?php if ($Page->nilai->Visible) { // nilai ?>
        <th data-name="nilai" class="<?= $Page->nilai->headerCellClass() ?>"><div id="elh_kurs_nilai" class="kurs_nilai"><?= $Page->renderFieldHeader($Page->nilai) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_kurs_tanggal" class="el_kurs_tanggal">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_kurs_nilai" class="el_kurs_nilai">
