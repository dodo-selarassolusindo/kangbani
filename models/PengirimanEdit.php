 ...
 * Page class
 */
class PengirimanEdit extends Pengiriman
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengirimanEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("pengirimanlist"); // Return to list page
                        return;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // akunbeli
        $this->akunbeli->setDbValueDef($rsnew, $this->akunbeli->CurrentValue, $this->akunbeli->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['akunbeli'])) { // akunbeli
            $this->akunbeli->CurrentValue = $row['akunbeli'];
        }
