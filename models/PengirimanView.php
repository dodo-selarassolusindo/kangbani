 ...
 * Page class
 */
class PengirimanView extends Pengiriman
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengirimanView";
    ...
    // CSS class/style
    public $CurrentPageName = "pengirimanview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "pengirimanlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "pengirimanlist"; // No matching record, return to list
                    } else {
