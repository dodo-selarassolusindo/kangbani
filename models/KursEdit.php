...
class KursEdit extends Kurs
{
    ...
    // CSS class/style
    public $CurrentPageName = "kursedit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("kurslist"); // Return to list page
                        return;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // tanggal
        $this->tanggal->setDbValueDef($rsnew, $this->tanggal->CurrentValue, $this->tanggal->ReadOnly);
