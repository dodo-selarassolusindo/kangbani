...
class KursAdd extends Kurs
{
    ...
    // CSS class/style
    public $CurrentPageName = "kursadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("kurslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "kurslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "kursview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "kurslist") {
                            ...
                            $returnUrl = "kurslist"; // Return list page content
                        }
                    }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if (!CheckInteger($this->tanggal->FormValue)) {
    ...
    protected function getAddRow()
    {
        ...
        // tanggal
        $this->tanggal->setDbValueDef($rsnew, $this->tanggal->CurrentValue, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("kurslist"), "", $this->TableVar, true);
