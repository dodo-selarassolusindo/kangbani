 ...
 * Page class
 */
class JurnaldEdit extends Jurnald
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JurnaldEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("jurnaldlist"); // Return to list page
                        return;
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("jurnaldlist"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "jurnaldlist") {
                            ...
                            $returnUrl = "jurnaldlist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jurnaldlist"), "", $this->TableVar, true);
        $pageId = "edit";
