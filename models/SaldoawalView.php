 ...
 * Page class
 */
class SaldoawalView extends Saldoawal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SaldoawalView";
    ...
    // CSS class/style
    public $CurrentPageName = "saldoawalview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "saldoawallist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "saldoawallist"; // No matching record, return to list
                    } else {
