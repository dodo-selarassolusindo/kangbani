 ...
 * Page class
 */
class KonversiDelete extends Konversi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KonversiDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "konversidelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("konversilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("konversilist"); // Return to list
                return;
            }
        }
