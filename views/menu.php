...
$topMenu->addMenuItem(50, "mci_Akuntansi", $Language->menuPhrase("50", "MenuText"), "", -1, "", true, false, true, "", "", true, false);
...
$topMenu->addMenuItem(4, "mi_jurnal", $Language->menuPhrase("4", "MenuText"), "jurnallist", 50, "", true, false, false, "", "", true, false);
$topMenu->addMenuItem(83, "mci_Barang", $Language->menuPhrase("83", "MenuText"), "", -1, "", true, false, true, "", "", true, false);
$topMenu->addMenuItem(21, "mi_tos", $Language->menuPhrase("21", "MenuText"), "toslist", 83, "", true, false, false, "", "", true, false);
$topMenu->addMenuItem(20, "mi_top", $Language->menuPhrase("20", "MenuText"), "toplist", 83, "", true, false, false, "", "", true, false);
...
$sideMenu->addMenuItem(50, "mci_Akuntansi", $Language->menuPhrase("50", "MenuText"), "", -1, "", true, false, true, "", "", true, true);
...
$sideMenu->addMenuItem(4, "mi_jurnal", $Language->menuPhrase("4", "MenuText"), "jurnallist", 50, "", true, false, false, "", "", true, true);
$sideMenu->addMenuItem(83, "mci_Barang", $Language->menuPhrase("83", "MenuText"), "", -1, "", true, false, true, "", "", true, true);
$sideMenu->addMenuItem(21, "mi_tos", $Language->menuPhrase("21", "MenuText"), "toslist", 83, "", true, false, false, "", "", true, true);
$sideMenu->addMenuItem(20, "mi_top", $Language->menuPhrase("20", "MenuText"), "toplist", 83, "", true, false, false, "", "", true, true);
