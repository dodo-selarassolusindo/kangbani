 ...
 * Page class
 */
class KlasifikasiAdd extends Klasifikasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KlasifikasiAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "klasifikasiadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "klasifikasiview") {
