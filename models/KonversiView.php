 ...
 * Page class
 */
class KonversiView extends Konversi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KonversiView";
    ...
    // CSS class/style
    public $CurrentPageName = "konversiview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "konversilist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "konversilist"; // No matching record, return to list
                    } else {
