 ...
 * Page class
 */
class PeriodeView extends Periode
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeriodeView";
    ...
    // CSS class/style
    public $CurrentPageName = "periodeview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "periodelist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "periodelist"; // No matching record, return to list
                    } else {
