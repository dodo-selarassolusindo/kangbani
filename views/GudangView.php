...
<?php } ?>
<?php } ?>
<form name="fgudangview" id="fgudangview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->kode->Visible) { // kode ?>
    <tr id="r_kode"<?= $Page->kode->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gudang_kode"><?= $Page->kode->caption() ?></span></td>
...
<?php if ($Page->nama->Visible) { // nama ?>
    <tr id="r_nama"<?= $Page->nama->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gudang_nama"><?= $Page->nama->caption() ?></span></td>
...
<?php if ($Page->lokasi->Visible) { // lokasi ?>
    <tr id="r_lokasi"<?= $Page->lokasi->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gudang_lokasi"><?= $Page->lokasi->caption() ?></span></td>
