 ...
 * Page class
 */
class KelompokView extends Kelompok
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KelompokView";
    ...
    // CSS class/style
    public $CurrentPageName = "kelompokview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "kelompoklist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "kelompoklist"; // No matching record, return to list
                    } else {
