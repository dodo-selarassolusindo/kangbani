 ...
 * Page class
 */
class PersonDelete extends Person
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PersonDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "persondelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("personlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("personlist"); // Return to list
                return;
            }
        }
