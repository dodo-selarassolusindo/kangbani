 ...
 * Page class
 */
class TipejurnalView extends Tipejurnal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipejurnalView";
    ...
    // CSS class/style
    public $CurrentPageName = "tipejurnalview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "tipejurnallist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "tipejurnallist"; // No matching record, return to list
                    } else {
