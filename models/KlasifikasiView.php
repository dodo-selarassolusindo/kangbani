 ...
 * Page class
 */
class KlasifikasiView extends Klasifikasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KlasifikasiView";
    ...
    // CSS class/style
    public $CurrentPageName = "klasifikasiview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "klasifikasilist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "klasifikasilist"; // No matching record, return to list
                    } else {
