...
$Page->showMessage();
?>
<form name="fperiodedelete" id="fperiodedelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->end->Visible) { // end ?>
        <th class="<?= $Page->end->headerCellClass() ?>"><span id="elh_periode_end" class="periode_end"><?= $Page->end->caption() ?></span></th>
<?php } ?>
