...
<link rel="stylesheet" href="<?= $basePath ?>css/select2.min.css?v=24.11.5">
<link rel="stylesheet" href="<?= $basePath ?>css/select2-bootstrap5.min.css?v=24.11.5">
<link rel="stylesheet" href="<?= $basePath ?><?= Config("FONT_AWESOME_STYLESHEET") ?>?v=24.11.5">
<link rel="stylesheet" href="<?= $basePath ?>adminlte3/css/<?= CssFile("adminlte.css") ?>?v=24.11.5">
<link rel="stylesheet" href="<?= $basePath ?><?= CssFile(Config("PROJECT_STYLESHEET_FILENAME")) ?>?v=24.11.5">
<script data-pace-options='<?= JsonEncode(Config("PACE_OPTIONS")) ?>' src="<?= $basePath ?>js/pace.js?v=24.11.5"></script><!-- Single quotes for data-pace-options -->
<script src="<?= $basePath ?>js/ewcore.min.js?v=24.11.5"></script>
<script>
var $rowindex$ = null;
Object.assign(ew, <?= JsonEncode(ConfigClientVars()) ?>, <?= JsonEncode(GlobalClientVars()) ?>);
loadjs(ew.PATH_BASE + "jquery/jquery.min.js?v=24.11.5", "jquery");
loadjs(ew.PATH_BASE + "js/popper.min.js?v=24.11.5", "popper");
loadjs(ew.PATH_BASE + "js/luxon.min.js?v=24.11.5", "luxon");
loadjs([
    ew.PATH_BASE + "js/mobile-detect.min.js?v=24.11.5",
    ew.PATH_BASE + "js/purify.min.js?v=24.11.5",
    ew.PATH_BASE + "js/cropper.min.js?v=24.11.5",
    ew.PATH_BASE + "jquery/load-image.all.min.js?v=24.11.5"
], "others");
loadjs(ew.PATH_BASE + "js/sweetalert2.all.min.js?v=24.11.5", "swal");
<?= $Language->toJson() ?>
ew.vars = <?= JsonEncode(GetClientVar()) ?>;
ew.ready(["wrapper", "jquery"], ew.PATH_BASE + "jquery/jsrender.min.js?v=24.11.5", "jsrender", ew.renderJsTemplates);
ew.ready("jquery", ew.PATH_BASE + "jquery/jquery-ui.min.js?v=24.11.5", "widget");
</script>
<?php include_once "views/menu.php"; ?>
<script>
var cssfiles = [
    ew.PATH_BASE + "css/jquery.fileupload.css?v=24.11.5",
    ew.PATH_BASE + "css/jquery.fileupload-ui.css?v=24.11.5",
    ew.PATH_BASE + "css/cropper.min.css?v=24.11.5"
];
cssfiles.push(ew.PATH_BASE + "colorbox/colorbox.css?v=24.11.5");
loadjs(cssfiles, "css");
var cssjs = [];
<?php foreach (array_merge(Config("STYLESHEET_FILES"), Config("JAVASCRIPT_FILES")) as $file) { // External Stylesheets and JavaScripts ?>
cssjs.push("<?= (IsRemote($file) ? "" : BasePath(true)) . $file ?>?v=24.11.5");
<?php } ?>
var jqueryjs = [
    ew.PATH_BASE + "jquery/select2.full.min.js?v=24.11.5",
    ew.PATH_BASE + "jquery/jqueryfileupload.min.js?v=24.11.5",
    ew.PATH_BASE + "jquery/typeahead.jquery.min.js?v=24.11.5"
];
jqueryjs.push(ew.PATH_BASE + "colorbox/jquery.colorbox.min.js?v=24.11.5");
jqueryjs.push(ew.PATH_BASE + "js/pdfobject.min.js?v=24.11.5");
ew.ready(["jquery", "dom", "popper"], ew.PATH_BASE + "bootstrap5/js/bootstrap.min.js?v=24.11.5", "bootstrap"); // Bootstrap
ew.ready("popper", ew.PATH_BASE + "js/tippy-bundle.umd.min.js?v=24.11.5", "tippy"); // Tippy
ew.ready("bootstrap", ew.PATH_BASE + "adminlte3/js/adminlte.min.js?v=24.11.5", "adminlte"); // AdminLTE (After Bootstrap)
ew.ready(["jquery", "widget"], [jqueryjs], "jqueryjs");
ew.ready(["bootstrap", "adminlte", "jqueryjs", "luxon", "others"], ew.PATH_BASE + "js/ew.min.js?v=24.11.5", "makerjs");
ew.ready("makerjs", [
    cssjs,
    ew.PATH_BASE + "js/userfn.js?v=24.11.5",
    ew.PATH_BASE + "js/userevent.js?v=24.11.5"
], "head");
</script>
<script>
...
<meta name="generator" content="PHPMaker 2024.10.3">
</head>
        ...
        <div class="container-fluid">
            ...
            <ul id="ew-navbar" class="navbar-nav">
                ...
                <a class="navbar-brand d-none d-sm-block" href="/">
                    <span class="brand-text">Kang Bani Accounting</span>
                </a>
            </ul>
            <!-- Right navbar links -->
