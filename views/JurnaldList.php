...
<?php
if ($Page->DbMasterFilter != "" && $Page->getCurrentMasterTable() == "jurnal") {
    if ($Page->MasterRecordExists) {
        include_once "views/JurnalMaster.php";
    }
}
?>
<?php } ?>
...
<?php } ?>
<?php if ($Page->getCurrentMasterTable() == "jurnal" && $Page->CurrentAction) { ?>
...
<?php } ?>
<div id="gmp_jurnald" class="card-body ew-grid-middle-panel <?= $Page->TableContainerClass ?>" style="<?= $Page->TableContainerStyle ?>">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit() || $Page->isMultiEdit()) { ?>
<table id="tbl_jurnaldlist" class="<?= $Page->TableClass ?>"><!-- .ew-table -->
<thead>
...
<?php if ($Page->debet->Visible) { // debet ?>
        <th data-name="debet" class="<?= $Page->debet->headerCellClass() ?>"><div id="elh_jurnald_debet" class="jurnald_debet"><?= $Page->renderFieldHeader($Page->debet) ?></div></th>
<?php } ?>
<?php if ($Page->kredit->Visible) { // kredit ?>
        <th data-name="kredit" class="<?= $Page->kredit->headerCellClass() ?>"><div id="elh_jurnald_kredit" class="jurnald_kredit"><?= $Page->renderFieldHeader($Page->kredit) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jurnald_debet" class="el_jurnald_debet">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jurnald_kredit" class="el_jurnald_kredit">
