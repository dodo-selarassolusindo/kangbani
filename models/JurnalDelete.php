 ...
 * Page class
 */
class JurnalDelete extends Jurnal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JurnalDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jurnaldelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jurnallist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("jurnallist"); // Return to list
                return;
            }
        }
