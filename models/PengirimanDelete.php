 ...
 * Page class
 */
class PengirimanDelete extends Pengiriman
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengirimanDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "pengirimandelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("pengirimanlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("pengirimanlist"); // Return to list
                return;
            }
        }
