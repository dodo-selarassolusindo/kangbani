...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "24.10.3");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "prj_accounting"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{6E044EB4-6227-43E6-89F6-E9F0A73B0333}"); // Project ID
